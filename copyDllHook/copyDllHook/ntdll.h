...
NtWaitForWorkViaWorkerFactory(
	...
	_In_ ULONG Count,
	_Out_ PULONG NumEntriesRemoved,
	_In_ PLARGE_INTEGER Unknown // Wrong type (but works). Possibly PLARGE_INTEGER Timeout, BOOLEAN Alertable like NtRemoveIoCompletionEx
	);
#else
